    ...
    <footer className="text-mdGray body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <a
          ...
          className="flex title-font font-medium items-center md:justify-start justify-center text-ltGray hover:text-yellow"
          download
        >
          <AiOutlineDownload size={32} className="mr-4"/>
          Download My Resume
        </a>
